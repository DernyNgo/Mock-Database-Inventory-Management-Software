...
/**
 * @author Daniel Ngo
 * Reports Type View Controller.
 */

public class ReportsType extends Reports {
    /**
    ...
    void reportsComboBoxAction(ActionEvent event) throws SQLException {
        ObservableList<Appointment> appointments = appointmentDAO.getAllAppointmentsByType(reportsComboBox.getValue());
    ...
    public void initialize() throws SQLException {
        setReportsTable();
        reportsComboBox.setItems(appointmentDAO.getDistinctAppointmentTypes());
        reportsComboBox.setPromptText("Select Type");
    }
